...
export const ARTIKEL_LIST: Artikel[] = [
    new BetriebsSystem(1, "Betriebssystem", 49.99, 1, "lien1", "Windows 10", "Microsoft"),
    new BetriebsSystem(2, "Betriebssystem", 79.99, 1, "lien2", "Ubuntu", "Canonical"),
    new BetriebsSystem(3, "Betriebssystem", 149.99, 1, "lien3", "macOS", "Apple"),
    new BetriebsSystem(4, "Betriebssystem", 29.99, 1, "lien4", "Fedora", "Red Hat"),

    new Cpu(5, "CPU", 199.99, 2, "lien5", "Intel", "Core i7", "95W", "3.6 GHz", "LGA 1200", "8", "UHD Graphics 630"),
    new Cpu(6, "CPU", 149.99, 2, "lien6", "AMD", "Ryzen 5", "65W", "3.4 GHz", "AM4", "6", "Radeon Vega"),
    new Cpu(7, "CPU", 299.99, 2, "lien7", "Intel", "Core i9", "125W", "3.8 GHz", "LGA 1151", "10", "UHD Graphics 630"),
    new Cpu(8, "CPU", 99.99, 2, "lien8", "AMD", "Athlon", "35W", "3.2 GHz", "AM4", "2", "Radeon Vega"),

    new Gehaeuse(9, "Gehaeuse", 79.99, 3, "lien9", "Corsair", "ATX Mid Tower", 2, "ATX", "Acier", "200 x 450 x 400 mm"),
    new Gehaeuse(10, "Gehaeuse", 69.99, 3, "lien10", "NZXT", "Mini-ITX", 1, "Mini-ITX", "Plastique", "180 x 360 x 300 mm"),
    new Gehaeuse(11, "Gehaeuse", 89.99, 3, "lien11", "Fractal Design", "ATX Full Tower", 4, "E-ATX", "Acier", "250 x 550 x 500 mm"),
    new Gehaeuse(12, "Gehaeuse", 49.99, 3, "lien12", "Cooler Master", "Micro-ATX", 3, "Micro-ATX", "Acier", "160 x 380 x 350 mm"),

    new Ram(13, "RAM", 79.99, 4, "lien13", "Corsair", "Vengeance LPX", "DDR4", "16 GB", "16-18-18-36"),
    new Ram(14, "RAM", 99.99, 4, "lien14", "G.Skill", "Trident Z", "DDR4", "32 GB", "15-16-16-35"),
    new Ram(15, "RAM", 59.99, 4, "lien15", "Crucial", "Ballistix", "DDR4", "8 GB", "16-18-18-36"),
    new Ram(16, "RAM", 149.99, 4, "lien16", "Kingston", "HyperX Fury", "DDR4", "64 GB", "17-19-19-39"),

    new Speicher(17, "Speicher", 99.99, 5, "lien17", "Samsung", "970 EVO", "NVMe M.2", "1 TB", "3500 MB/s", "3300 MB/s"),
    new Speicher(18, "Speicher", 79.99, 5, "lien18", "Crucial", "BX500", "SATA", "480 GB", "540 MB/s", "500 MB/s"),
    new Speicher(19, "Speicher", 149.99, 5, "lien19", "WD", "Black SN750", "NVMe M.2", "2 TB", "3470 MB/s", "3000 MB/s"),
    new Speicher(20, "Speicher", 69.99, 5, "lien20", "Seagate", "BarraCuda", "HDD", "4 TB", "256 MB Cache", "5400 RPM")
]
